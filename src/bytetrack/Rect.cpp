...
template <typename T>
const T& byte_track::Rect<T>::x() const { return tlwh[0]; }

template <typename T>
const T& byte_track::Rect<T>::y() const { return tlwh[1]; }

template <typename T>
const T& byte_track::Rect<T>::width() const { return tlwh[2]; }

template <typename T>
const T& byte_track::Rect<T>::height() const { return tlwh[3]; }

template <typename T>
T& byte_track::Rect<T>::x() { return tlwh[0]; }

template <typename T>
T& byte_track::Rect<T>::y() { return tlwh[1]; }

template <typename T>
T& byte_track::Rect<T>::width() { return tlwh[2]; }

template <typename T>
T& byte_track::Rect<T>::height() { return tlwh[3]; }

template <typename T>
const T& byte_track::Rect<T>::tl_x() const { return tlwh[0]; }

template <typename T>
const T& byte_track::Rect<T>::tl_y() const { return tlwh[1]; }

template <typename T>
T byte_track::Rect<T>::br_x() const { return tlwh[0] + tlwh[2]; }

template <typename T>
T byte_track::Rect<T>::br_y() const { return tlwh[1] + tlwh[3]; }
